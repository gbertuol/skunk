  ...
  val Static: Typer = new Typer {
    ...
    val staticByOid: Map[Int, Type] =
      Map(
        ...
        2282 -> opaque,        602  -> path,             3220 -> pg_lsn,       600  -> point,
        604  -> polygon,       2249 -> record,           1790 -> refcursor,    2205 -> regclass,
        3734 -> regconfig,     3769 -> regdictionary,    4089 -> regnamespace, 2203 -> regoper,
        2204 -> regoperator,   24   -> regproc,          2202 -> regprocedure, 4096 -> regrole,
        2206 -> regtype,       703  -> reltime,          210  -> smgr,         25   -> text,
        27   -> tid,           1083 -> time,             1114 -> timestamp,    1184 -> timestamptz,
        1266 -> timetz,        704  -> tinterval,        2279 -> trigger,      3310 -> tsm_handler,
        3615 -> tsquery,       3908 -> tsrange,          3910 -> tstzrange,    3614 -> tsvector,
        2970 -> txid_snapshot, 705  -> unknown,          2950 -> uuid,         1562 -> varbit,
        1043 -> varchar,       2278 -> void,             28   -> xid,          142  -> xml,
